/**
 * Canonical cursor owner. DOM inputs: #cursor-container, .cursor-follow and .circle-follow;
 * dependencies: DOM and requestAnimationFrame. One deferred load creates one animation loop
 * and delegated pointer listeners; a page without canonical cursor chrome is a no-op.
 * The RAF/listeners live for the document lifetime; canonical pages have no SPA teardown.
 */
(function () {
